                ...
                <ul className="space-y-4 text-sm">
                  <li>
                    <Link
                      ...
                      to={"/product-category?category=" + "refrigerator"}
                    >
                      Refrigerator
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      className="text-white transition hover:text-white/75"
                      to={"/product-category?category=" + "televisions"}
                    >
                      Televisions
                    </Link>
                  </li>
